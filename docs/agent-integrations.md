...
The Herdr Claude hook under `~/.claude/hooks/` is generated by
`herdr integration install claude` and intentionally ignored by Git. The
playbook refreshes it after deploying the repository-owned Claude dotfiles.
